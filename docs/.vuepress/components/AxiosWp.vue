<template>
  <section
    class="py-4 px-2 color-bg-subtle"
    data-color-mode="auto"
    data-light-theme="light"
    data-dark-theme="dark_dimmed"
  >
    <div class="Subhead px-3 color-bg-subtle">
    ...
    <div id="Box_Container">
      <div v-for="plugin in plugins" :key="plugin">
        <div
          v-if="plugin.name == 'Akismet Anti-Spam' + 'Hide My WP Ghost Lite'"
          class="hide"
        ></div>
        <div
          v-else-if="plugin.name == 'Hide My WP Ghost Lite'"
          class="hide"
        ></div>
        ...
        >
          <div class="Box-header">
            <h4 class="Box-title" v-if="plugin.name == 'ManageWP - Worker'">
              Maintenance HRSlab WP<span
                class="State State--small State--open float-right"
                >{{ plugin.status }}</span
              >
            </h4>
            <!-- V-ELSE -->
            <h4 v-else class="Box-title">
              ...
              <span
                ...
                class="State State--small State--closed float-right"
                >{{ plugin.status }}</span
              >
            </h4>
          </div>
          <div class="Box-body">
            <p v-if="plugin.name == 'ManageWP - Worker'">
              ...
              <a href="https://www.hrslab.com/" target="blank"> HRS </a> di
              eseguire tutte le attività di manutenzione senza accedere al tuo
              sito. Per maggiori informazioni:
              <a href="mailto:developers@hrslab.com">developers@hrslab.com</a>
            </p>
